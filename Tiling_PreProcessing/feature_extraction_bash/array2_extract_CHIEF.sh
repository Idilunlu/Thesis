# this script is used to extract CHIEF features from the patches of the dataset using the feature_CHIEF2.py script.
...
# File path should be updated depending on the file structure 
...
#FILE_PATH="/n/scratch/users/i/idu675/MGB_coords/2_StageInII_MGH_35_Controls_BWHScanner/patch_coord/BD2021_00017901.h5"
...
/home/idu675/.conda/envs/notebookenv/bin/python /home/idu675/projects/melanoma_Process/feature_CHIEF2.py \
    ...
    --save_root /n/scratch/users/i/idu675/2_StageInII_MGH_35_Controls_BWHScanner/CHIEF_features \
    --log_file /n/scratch/users/i/idu675/2_StageInII_MGH_35_Controls_BWHScanner/CHIEF_features/extraction_${SLURM_ARRAY_TASK_ID}.log \
