...
export OUTPUT_DIR="/home/idu675/projects/Thesis/catDreambooth/outputs_specified"
export LOGGING_DIR="/home/idu675/projects/Thesis/catDreambooth/logs_specified"

# Launch the Dreambooth training script with specified parameters
accelerate launch Dreambooth.py \
  --pretrained_model_name_or_path=$MODEL_NAME \
  --instance_data_dir=$INSTANCE_DIR \
  --instance_prompt="Generate a high resolution frozen brain histopathology slide of a 20 years old woman diagnosed with IDH mutation and low grade glioma with 20x magnification" \
  --class_data_dir=$CLASS_DATA_DIR \
  ...
  --validation_epochs=4 \
  --validation_prompt="Generate a high resolution frozen brain histopathology slide of a 20 years old woman diagnosed with IDH mutation and low grade glioma with 20x magnification" \
